...
namespace UnityEngine.UI.Extensions
{
    ...
    public class BezierLineRendererEditor : Editor
    {
        private void OnSceneGUI()
        {
            ...
            if (!curveRenderer || curveRenderer.drivenExternally || curveRenderer.Points == null
                || curveRenderer.Points.Length < 2)
                return;
            ...
            for (var i = 0; i < curveRenderer.Points.Length; i++) points[i] = curveRenderer.Points[i];
            ...
            for (var i = 0; i < points.Length - 1; i += 2) Handles.DrawLine(points[i], points[i + 1]);
