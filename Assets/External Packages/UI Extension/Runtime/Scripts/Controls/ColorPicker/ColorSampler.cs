...
namespace UnityEngine.UI.Extensions.ColorPicker
{
    ...
    {
        [SerializeField] protected Button sampler;

        [SerializeField] protected Outline samplerOutline;

        public ColorChangedEvent oncolorSelected = new();
        ...
        {
            if (oncolorSelected != null) oncolorSelected.Invoke(color);
