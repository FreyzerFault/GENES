...
namespace UnityEngine.UI.Extensions
{
    ...
    public class SelectionBox : MonoBehaviour
    {
        ...
        public SelectionEvent onSelectionChange = new();
        ...
        private void ValidateCanvas()
        {
            ...
            if (canvasScaler && canvasScaler.enabled && (!Mathf.Approximately(canvasScaler.scaleFactor, 1f)
        ...
        private void BeginSelection()
        {
            ...
            if (!UIExtensionsInputManager.GetMouseButtonDown(0)) return;
            ...
            foreach (var behaviour in behavioursToGetSelectionsFrom)
            {
                ...
                if (selectable != null)
                {
                    ...
                    if (!UIExtensionsInputManager.GetKey(KeyCode.LeftShift)) selectable.selected = false;
                }
            }
        ...
        private IBoxSelectable GetSelectableAtMousePosition()
        {
            ...
            if (!PointIsValidAgainstSelectionMask(UIExtensionsInputManager.MousePosition)) return null;
            ...
            foreach (var selectable in selectables)
            {
                ...
                if (rectTransform)
                {
                    ...
                    if (RectTransformUtility.RectangleContainsScreenPoint(
                            rectTransform,
                            UIExtensionsInputManager.MousePosition,
                            screenCamera
                        ))
        ...
        private void DragSelection()
        {
            ...
            if (!UIExtensionsInputManager.GetMouseButton(0) || !boxRect.gameObject.activeSelf) return;

            // Store the current mouse position in screen space.
            var currentMousePosition = new Vector2(
                UIExtensionsInputManager.MousePosition.x,
                UIExtensionsInputManager.MousePosition.y
            );
            ...
            foreach (var selectable in selectables)
            {
                ...
                selectable.preSelected = RectTransformUtility.RectangleContainsScreenPoint(boxRect, screenPoint, null)
        ...
        private void ApplySingleClickDeselection()
        {
            ...
            if (clickedBeforeDrag == null) return;
        ...
        private Camera GetScreenPointCamera(RectTransform rectTransform)
        {
            ...
            do
            {
                ...
                if (rootCanvas && !rootCanvas.isRootCanvas) rootCanvas = null;
        ...
        private void EndSelection()
        {
            ...
            if (!UIExtensionsInputManager.GetMouseButtonUp(0) || !boxRect.gameObject.activeSelf) return;
