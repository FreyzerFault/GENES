...
namespace UnityEngine.UI.Extensions
{
    ...
    public class SegmentedControl : UIBehaviour
    {
        ...
        private SegmentSelectedEvent m_onValueChanged = new();
        ...
        protected float SeparatorWidth
        {
            get
            {
                if (m_separatorWidth == 0 && separator)
                {
                    ...
                    if (image) m_separatorWidth /= image.pixelsPerUnit;
                }
        ...
        public int selectedSegmentIndex
        {
            ...
            set
            {
                ...
                if (m_selectedSegmentIndex == value) return;
                ...
                if (selectedSegment)
                {
                    ...
                    if (segment) segment.selected = false;
                ...
                if (value != -1)
                {
                    ...
                    var segment = selectedSegment.GetComponent<Segment>();
                    if (segment) segment.selected = true;
                }
            }
        }
        ...
        protected override void OnValidate()
        {
            ...
            if (m_selectedSegmentIndex > transform.childCount) selectedSegmentIndex = transform.childCount - 1;
        }
#endif
        ...
        private void RecreateSprites()
        {
            for (var i = 0; i < segments.Length; i++)
            {
                ...
                if (segment) segment.cutSprite = sprite;
        ...
        public void LayoutSegments()
        {
            ...
            for (var i = 0; i < segments.Length; i++)
            {
                ...
                if (separator && i > 0)
                {
                    ...
                    sep.rectTransform.SetInsetAndSizeFromParentEdge(
                        RectTransform.Edge.Left,
                        insetX - SeparatorWidth,
                        SeparatorWidth
                    );
