...
namespace UnityEngine.UI.Extensions
{
    ...
    public class HoverTooltip : MonoBehaviour
    {
        ...
        public void OnScreenSpaceCamera()
        {
            ...
            var newPos = GUICamera.ScreenToViewportPoint(UIExtensionsInputManager.MousePosition);
            ...
            transform.parent.transform.position = new Vector3(
                GUICamera.ViewportToWorldPoint(newPos).x,
                GUICamera.ViewportToWorldPoint(newPos).y,
                0f
            );
        ...
        private void LayoutInit()
        {
            if (firstUpdate)
            {
                ...
                bgImage.sizeDelta = new Vector2(
                    hlG.preferredWidth + horizontalPadding,
