...
namespace UnityEngine.UI.Extensions
{
    ...
    public class Gradient : BaseMeshEffect
    {
        ...
        [SerializeField] private bool _overwriteAllColor;
        ...
        public override void ModifyMesh(VertexHelper vh)
        {
            ...
            if (_gradientMode == GradientMode.Global)
            {
                ...
                var bottomY = _gradientDir == GradientDir.Vertical
            ...
            else
            {
                ...
                {
                    vh.PopulateUIVertex(ref uiVertex, i);
                    if (!_overwriteAllColor && !CompareCarefully(uiVertex.color, targetGraphic.color)) continue;
                    switch (_gradientDir)
                    {
                        ...
                        case GradientDir.DiagonalLeftToRight:
                            uiVertex.color *= i % 4 == 0 ? _vertex1 :
                                (i - 2) % 4 == 0 ? _vertex2 : Color.Lerp(_vertex2, _vertex1, 0.5f);
                            break;
                        case GradientDir.DiagonalRightToLeft:
                            uiVertex.color *= (i - 1) % 4 == 0 ? _vertex1 :
        ...
        private bool CompareCarefully(Color col1, Color col2)
        {
            if (Mathf.Abs(col1.r - col2.r) < 0.003f && Mathf.Abs(col1.g - col2.g) < 0.003f
                                                    && Mathf.Abs(col1.b - col2.b) < 0.003f
                                                    && Mathf.Abs(col1.a - col2.a) < 0.003f)
                return true;
            return false;
        }
