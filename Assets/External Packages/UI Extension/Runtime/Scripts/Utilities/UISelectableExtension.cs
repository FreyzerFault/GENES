...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UISelectableExtension : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private void Update()
        {
            ...
            if (OnButtonHeld != null) OnButtonHeld.Invoke(_heldEventData.button);
        }
        ...
        void IPointerDownHandler.OnPointerDown(PointerEventData eventData)
        {
            ...
            if (OnButtonPress != null) OnButtonPress.Invoke(eventData.button);
            _pressed = true;
        ...
        void IPointerUpHandler.OnPointerUp(PointerEventData eventData)
        {
            ...
            if (OnButtonRelease != null) OnButtonRelease.Invoke(eventData.button);
            _pressed = false;
            _heldEventData = null;
        }
