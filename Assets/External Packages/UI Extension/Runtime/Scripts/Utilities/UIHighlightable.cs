...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIHighlightable : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler,
        IPointerUpHandler
    {
        [SerializeField]
        ...
        public bool Highlighted
        {
            ...
            set
            {
                if (m_Highlighted != value)
                {
                    m_Highlighted = value;
                    HighlightInteractable(m_Graphic);
                    if (m_Interactable) OnHighlightChanged?.Invoke(m_Highlighted);
                }
            }
        }
        ...
        public bool Pressed
        {
            ...
            set
            {
                if (m_Pressed != value)
                {
                    ...
                    if (m_Interactable) OnPressChanged?.Invoke(m_Pressed);
                }
            }
        }
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            {
                HighlightInteractable(m_Graphic);
                if (m_Interactable) OnPressChanged?.Invoke(false);
            }
        }
