...
namespace UI.MapUI
{
    ...
    {
        [SerializeField] private PathGenerator pathFindingGenerator = null;
        ...
        public void SetPath(Path path, int index = -1) =>
            lineRenderers[index].Points = path.GetPathNormalizedPoints(pathFindingGenerator.terrain) // Normalize the Path to the Terrain
