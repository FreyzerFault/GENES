...
namespace UI.MapUI
{
    ...
    {
        private static PathFindingGenerator PathGenerator => PathFindingManager.Instance.mainPathFindingGenerator;
            ...
            switch (MarkerManager.Instance.EditMarkerMode)
            {
                case EditMarkerMode.Add:
                    ...
                    else
                    {
                        ...
                        bool isLegal = PathGenerator.IsLegal(NormalizedPositionInMap);
