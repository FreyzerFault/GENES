...
public class Minimap : MonoBehaviour, IPointerMoveHandler, IPointerClickHandler
{
    public float zoomScale = 2;
    public Gradient heightGradient = new();
    [SerializeField] private GameObject player;
    [SerializeField] private RectTransform MousePoint;
    ...
    {
        Instantiate(pointMarker, eventData.position, Quaternion.identity, transform);
    }
    ...
    public void OnPointerMove(PointerEventData eventData)
    {
        ...
        MousePoint.position = eventData.position;
    }
