    ...
    public class Node
    {
        ...
        public void OnGizmos(Color color, float heightOffset = 0, bool wire = false, bool showValues = false)
        {
            ...
            if (slopeAngle > 0)
            {
                ...
                GizmosUtils.DrawArrow(pos, normal, size / 2);

                // Gradiente
                Gizmos.color = Color.blue;
                GizmosUtils.DrawArrow(pos, tangentGradient);
            }
            ...
            if (direction != Vector2.zero)
            {
                ...
                GizmosUtils.DrawArrow(pos, new Vector3(direction.x, 0, direction.y), size / 2);
            }
