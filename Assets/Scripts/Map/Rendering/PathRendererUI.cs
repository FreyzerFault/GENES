...
namespace Map.Rendering
{
    ...
    {
        [SerializeField]
        protected List<UILineRenderer> lineRenderers = new();

        [SerializeField]
        protected UILineRenderer linePrefab;
        ...
        {
            foreach (var uiLineRenderer in lineRenderers)
                uiLineRenderer.LineThickness = lineThickness / zoomAmount;
        }
    }
}
